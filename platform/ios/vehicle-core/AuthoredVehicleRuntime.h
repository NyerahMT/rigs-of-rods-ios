...
struct NodeBeamDiagnostic { std::size_t beam=static_cast<std::size_t>(-1),other=static_cast<std::size_t>(-1); float initial_length=0,rest_length=0,spring=0,damping=0,initial_stress=0,initial_force=0; };
